      ...
      >
          ...
          <div className="col">
            <Balance
              ...
              unit=""
              color={rawStakedBalance && "warning"}
            />
            <Text color={rawStakedBalance && "warning"}>Deposited</Text>
          </div>
          <div className="col">
            <Balance
              fontSize="16px"
              ...
              unit=""
              color={rawEarningsBalance && "warning"}
            />
            <Text   color={rawEarningsBalance && "warning"}>Rewards</Text>
          </div>
          <div className="col">
            <Balance
              fontSize="16px"
